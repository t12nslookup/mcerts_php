...
{			
	...
	for($i=1;$i<12;$i++) 
	{
		...
		if($year!="" && $secondyear!="")
		{
			$sqlDeleteBatches=sprintf("delete from batches where referencematerialid=%s and
...
<form name="form1" method="post" action="">
  <table width="600"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
        <td colspan="2"><div align="center"><?php echo getStringDateTime($row_ExistingBatches['REPLICATE1']); ?></div></td>
        <td colspan="2"><div align="center"><?php echo getStringDateTime($row_ExistingBatches['REPLICATE2']); ?></div></td>
      </tr>
	  <?php }//end for ?>
      <tr class="tableheader">
        <td width="19%">Date</td>
