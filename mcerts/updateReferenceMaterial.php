...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	$updateSQL = sprintf(
		"UPDATE reference_materials SET ReferenceMaterial=%s, TrivialName=%s, DEFAULTTARGETSTANDARDDEVIATION=%s, DefaultTargetBias=%s, IncludeInReport=%s WHERE ReferenceMaterialID=%s",
	...
	<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr valign="baseline">
				...
				<td><input type="checkbox" name="IncludeInReport" value="1" <?php if (!(strcmp($row_ReferenceMaterial['INCLUDEINREPORT'], "1"))) {
																																			echo "checked";
																																		} ?>></td>
			</tr>
			<tr valign="baseline">
