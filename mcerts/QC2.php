...
<body>
<h3><a href="index.php">View All Validation Reports</a> &gt; Compound Report </h3>
<p align="center"><a href="../reports/<?php echo $EID2 ?>.htm">[view summary]</a>
<?php
  if($locked!=true) { ?> 
  <a href="editValues.php?ReferenceMaterialID=<?php echo $_GET['ReferenceMaterialID']?>&Compound=<?php echo $compound?>">[edit concentrations for this compound]</a> <a href="selectBatches.php?ReferenceMaterialID=<? echo $_GET['ReferenceMaterialID']?>">[select batches]</a> 
  <?php } ?>
</p>
