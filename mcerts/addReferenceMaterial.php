...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2") && isset($_GET["EID"])) {
	...
	$insertMaterial = sprintf(
		"INSERT INTO reference_materials (ReferenceMaterial, TrivialName, DEFAULTTARGETSTANDARDDEVIATION, DefaultTargetBias, IncludeInReport) VALUES (%s, %s, %s, %s, %s)",
	...
	$insertLink = sprintf(
		"INSERT INTO validation_reference_materials (EID, ReferenceMaterialID) 
							VALUES (%s, %s)",
	...
	<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
		<table border="0" cellpadding="0" cellspacing="0" class="InputForm">
			<tr valign="baseline">
				...
				<td width="640"><?php if (isset($_GET['EID'])) {
													echo $EquipmentID;
												} ?></td>
			</tr>
