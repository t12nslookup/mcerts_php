				...
				?>
					<td width="80">
						<a href="QC.php?ReferenceMaterialID=<?php echo $ReferenceMaterialID[$x] ?>&Compound=<?php echo $compounds[$i] ?>">
							<span class="<?php if ($Precision == "FAIL") echo "Fail";
														else echo "Pass"; ?>"><?php echo $Precision ?></span>
						</a>
					</td>
					<td width="80">
						<a href="QC.php?ReferenceMaterialID=<?php echo $ReferenceMaterialID[$x] ?>&Compound=<?php echo $compounds[$i] ?>">
							<span class="<?php if ($Bias == "FAIL") echo "Fail";
														else echo "Pass"; ?>"><?php echo $Bias ?></span>
						</a>
					</td>
				<?php } ?>
			</tr>
