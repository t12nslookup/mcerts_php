...
<body>
	<div align="center">
		<h3 class="title" id="refmat"><a href="index.php">All Validation Reports</a></h3>
		<p>
		...
		<p>
			<?php if (isset($_GET['SHOWEXPIRED'])) { ?>
				<span class="style2"><a href="index.php">View non-expired validation reports</a>
					<p>

					<?php } else { ?>
						<a href="index.php?SHOWEXPIRED=true">View expired validation reports</a>
					<p>
					<?php } ?>
					<p>
						...
						?>
							<tr>
								...
								<?php if ($locked != true) { ?>
									...
									<td>
										<div align="center"><a href="viewReferenceMaterials.php?EID=<?php echo $validationReport['EID'] ?>">View</a> </div>
									</td>
								<?php } ?>
								<td>
									<div align="center"><a href="../reports/MCERTS<?php echo $validationReport['EID'] ?>.htm">View</a>
								...
								<td>
									<div align="center">
										<?php if ($locked != true && $validationReport['LOCKED'] != 1) { ?>
											<a href="CalculateLevelSummary.php?EID=<?php echo $validationReport['EID'] ?>">Create</a> |
											<a href="../reports/<?php echo $validationReport['EID'] ?>.htm">View</a><br>
											<a href="CalculateLevelSummary.php?EID=<?php echo $validationReport['EID'] ?>&locked=true&final=true">Create final</a> |
