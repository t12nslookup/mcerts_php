...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	$updateSQL = sprintf("UPDATE compounds SET Compound=%s, TargetConcentration=%s, TargetStandardDeviation=%s, TargetBias=%s, IncludeInReport=%s WHERE CompoundID=%s",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
	  <table border="0" cellpadding="0" cellspacing="0" class="InputForm">
		...
		<tr valign="baseline">
		  ...
		  <td><input type="checkbox" name="IncludeInReport" value="1"  <?php if (!(strcmp($row_Compound['INCLUDEINREPORT'],"1"))) {echo "checked";} ?>></td>
		</tr>
		<tr valign="baseline">
