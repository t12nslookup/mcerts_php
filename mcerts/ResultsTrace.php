...
$sqlResultIds = sprintf("select resultid, concentration,AcqOn from results
						    ...
						    and AcqOn IN (select Replicate1
								  ...
								  ,$compoundID,$refMatId,$refMatId);

$sqlResultIds2 = sprintf("select resultid, concentration,AcqOn from results
							where compound=(SELECT Compound
			                				from compounds
                							where CompoundID=%s)
    						and Sample=(select ReferenceMaterial
