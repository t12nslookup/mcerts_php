...
$query_CRM = sprintf("select reference_materials.ReferenceMaterialID, reference_materials.ReferenceMaterial, trivialname
...
<?php for($i=0;$i<$compoundCounter;$i++) { 
	...
	<?php for($x=0;$x<$crmCounter;$x++) { 
		...
		<?php if(isset($resultArray['LOD'])) {echo sigfigs($resultArray['LOD'],3,3);} ?>
