...
<?php }?>
		...
		<td><div align="center"><a href="QC.php?ReferenceMaterialID=<?php echo $row_ReferenceMaterial['REFERENCEMATERIALID']?>&CompoundID=<?php echo $row_Compounds['COMPOUNDID']?>">[VIEW]</a></div></td>
		<td><div align="center"><?php echo $row_Compounds['TARGETSTANDARDDEVIATION']; ?></div></td>
		<td><div align="center"><?php echo $row_Compounds['TARGETCONCENTRATION']; ?></div></td>
		<td><div align="center"><?php echo $row_Compounds['TARGETBIAS']; ?></div></td>
		<td><div align="center"><?=sigfigs($row_Compounds['SUMMARY_PRECISION'],3,3)?></div></td>
		<td><div align="center"><?=sigfigs($row_Compounds['SUMMARY_BIAS'],3,3)?></div></td>		
