...
<div class="box"> 
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr class="tableheader">
      ...
      <td width="120"><div align="center">Observed Parameter</div></td>
      <td><div align="center">Response</div></td>
      <td><div align="center">Conc</div></td>
      <td><div align="center">Units</div></td>
      <td><div align="center">Dev (Min)</div></td>
      <td>Flag</td>
    </tr>
    <?php foreach($InternalStandards as $row_InternalStandards) { ?>
	    <tr>
		  ...
		  <td><?php if($row_InternalStandards['TOP']>"") {echo $row_InternalStandards['TOP']; ?>
    ...
    <tr class="tableheader">
      ...
      <td><div align="center">Conc</div></td>
      <td><div align="center">Units</div></td>
      <td><div align="center">QValue</div></td>
      <td>&nbsp;</td>
    </tr>
    <?php foreach($NormalResults as $row_NormalResults) { ?>
	    <tr>
		  ...
		  <td><?php if($row_NormalResults['TOP']>"") {echo $row_NormalResults['TOP']; ?>
