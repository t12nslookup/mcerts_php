...
function isInorganicData($fileContents)
{
       ...
       if(preg_match('/Solution Label/',$fileContents)
...
function parseInorganics($fileContents)
{
       ...
       for($i=2;$i<count($lines);$i++)
       {
               ...
               $acqOn=$date;
				...
				$deleteSQL[$i-2]=sprintf("delete from results where date=%s and datafile=%s and compound=%",
										getSQLDate($date),
										GetSQLValueString($dataFile, "text"),
										GetSQLValueString($element, "text"));
				
               $insertSQL[$i-2]=sprintf("INSERT INTO results (DataPath, DataFile,AcqOn, Operator,Sample,SampleMultiplier,Compound,QIon,Response, Concentration, top, bottom,Machine,Flag,Type,SD,RSD,IntSD,IntRSD,ActWgt,ActVol,DF,Sampleno,jobno,sampleconcentration,sampletype) VALUES (%s,%s, %s, %s,%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s, %s, %s, %s, %s, %s)",
...
function parseQuantitationReport($fileContents)
{
       ...
       if (preg_match('/\d+(\.)*\d+ (a|f|p|n|u|m|k)(g|l)\/(a|f|p|n|u|m|k)(g|l)/', $matches[0][$i], $regs)) {
               ...
               $insertSQL[$i] = sprintf("INSERT INTO results (DataPath, DataFile, AcqOn, Operator, Sample, Misc, ALSVial, SampleMultiplier, QuantTime, QuantMethod, QuantTitle, QuantUpdate, ResponseVia, Compound, RT, QIon, Response, Concentration, top, bottom, QValue, Deviation, Machine,LineNo,Flag) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s)",
                      GetSQLValueString($dataPath, "text"),
                      GetSQLValueString($dataFile, "text"),
